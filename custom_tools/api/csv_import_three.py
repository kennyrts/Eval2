...
def initialize_base_requirements():
    ...
    if not frappe.db.exists("Company", "Orinasa"):
        try:
            company = frappe.new_doc("Company")
            company.company_name = "Orinasa"
            company.abbr = "O"
            company.default_currency = "MGA"
...
def import_warehouses(csv_path):
    ...
    try:
        ...
        default_company = frappe.defaults.get_global_default("company") or "Orinasa"
...
def import_material_requests_and_rfqs(csv_path, supplier_mapping):
    ...
    try:
        ...
        # Obtenir l'entreprise par défaut (Orinasa)
        default_company = "Orinasa"
        ...
        # Générer un message récapOlatif avec les erreurs
